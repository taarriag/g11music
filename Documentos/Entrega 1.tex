...
Nuestro dispositivo consistirá en un periférico para computador, el cual controlará tanto el volumen de la reproducción como la música que se toca. Para esto, debe poder sensar el ambiente con el fin de detectar cambios en la intensidad de luz y del ruido ambiental, regulando el tipo de música y el volumen de ésta respectivamente.
...
Además el dispositivo permitirá al usuario configurar el dispositivo desde un PC y programar el tiempo en el cuál se encenderá/apagara por medio de un botón físico.
Adicionalmente al control automático de la música, el dispositivo permitirá comenzar y pausar la reproducción cuando el usuario lo desee, como también adelantar y retroceder de canción. Además se mostrará al usuario el nombre de la canción que se está reproduciendo y el valor del contador del timer. 

\subsection{Características}
Para poder realizar las funcionalidades definidas en el apartado anterior, el periférico debe estar compuesto por los siguientes dispositivos. En primer lugar debe poseer un sensor que le permita detectar el ruido ambiente. De esta forma, cuando el ruido ambiente aumenta, el dispositivo determina un aumento del volumen de la música que está reproduciendo el computador. Junto con lo anterior, el dispositivo debe tener un sensor lumínico el cual permita medir la luminosidad del ambiente, determinando qué tipo de música reproducir. Luego, a través del análisis de los datos entregados por los dos sensores anteriores, el dispositivo controlará la reproducción de la música.\\

Continuar:\\
sensores:\\
-sensor de sonido, esoecializado\\
-sensor de luz\\
-potenciometro\\
-pantalla 7 segmentos hora\\
-pantalla para titulo de la cancion(opcional)\\
\\
...
-forward-backward\\
-controlar volumen\\
-controlar sensor de volumen y intensidad lumínica\\
