...
\subsubsection{Pulsadores}
	\begin{itemize}
		...
		\item Conexión al PIC: Los cuatro botones a utilizar están conectados a pines del puerto B cayos cambios puede ser detectados para lanzar una interrupción (RB4, RB5, RB6 Y RB7)
	\end{itemize}
