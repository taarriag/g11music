...
\section{Descripción del Diseño (Diseño)}
...
\end{enumerate}	
	...
	En base al valor convertido de las intensidades se han definido tres niveles de intensidad\footnote{Estos valores están sujetos a cambios futuros}:
	\begin{itemize}
...
\end{table}
%----------------------------------------
comunicacion bidireccional con dispositivo externo.\\
