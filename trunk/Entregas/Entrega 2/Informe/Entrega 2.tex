...
El MAX232 tiene como funcion convertir las señales del puerto serial RS-232 a TTL para ser usadas por el PIC. Tiene 16 pines que seran explicados a continuacion (Ver el pic \ref{fig:max232} y sus pines \ref{tbl:pinesmax232}):
%-----------------------------------------
\begin{figure}
	\label{fig:max232}
	\begin{center}
